...
const DetalleSolicitudesLevantamiento = () => {
  ...
  useEffect(() => {
    const fetchSolicitudesDetalle = async () => {
      try {
        setLoading(true);
        const response = await axios.get(`${API_URL}/api/solicitudes/levantamiento/${codigo}/${grupo}`);
      ...
      <div className="dashboard-content">
        <div className="breadcrumb-container">
          <button 
            ...
            onClick={() => navigate('/admin/solicitudes-levantamiento')}
                          ...
                          <tr key={solicitud.id}>
                            ...
                            <td headers="col-acciones">
                              <button 
                                ...
                                onClick={() => navigate(`/admin/solicitudes-levantamiento/${codigo}/${grupo}/${solicitud.id}`)}
